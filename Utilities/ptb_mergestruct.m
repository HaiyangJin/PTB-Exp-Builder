function S = ptb_mergestruct(varargin)
...
%  >> s3 = ptb_mergestruct(s1,s2)
%  s3 = 
%     foo: 14
%     bar: 'some string'
%     something: 25
%
%  >> s4 = ptb_mergestruct(s3,'foo',32,'code,'helloworld')
%  s4 = 
%     foo: 32
%     bar: 'some string'
%     something: 25
...
%
% Example 2: 
%  >> s1 = ptb_mergestruct('foo',7,'bar','some string','foo',32);
%  s1 = 
%     foo: 32
%     bar: 'some string'
